...
def test_03_write_packages_with_services_with_override(package_to_image_placer_binary):
    ...
    package3 = "test_data/normal_package3"
    package1_zip = package1 + ".zip"
    package2_zip = package2 + ".zip"
    package3_zip = package3 + ".zip"
    service1 = "test_data/service1.service"
    partitions = [1, 3]
    ...
    create_test_package(package3, "10KB", services=[service1])
    ...
    create_config(
        ...
        [
            ...
            create_normal_package_config(package3_zip, True, service_name_suffix="test"),
        ],
        partitions,
    )
...
def test_09_try_to_write_service_when_package_do_not_contain_any_service(
    package_to_image_placer_binary,
):
    """Creates package without service file and try to write it with service. It should crash."""
    config = "test_data/test_config.json"
    img_in = "test_data/test_img.img.in"
    img_out = "test_data/test_img_out.img"
    package = "test_data/normal_package"
